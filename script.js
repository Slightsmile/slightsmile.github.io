...
const DATA = {
    ...
    projects: [
        { title: 'AIHR', description: 'A multi-tenant AI-powered HR platform with on-premise AI inference, tenant-isolated databases, video interview intelligence, CV matching, employee engagement, performance management, workforce insights, and enterprise-grade RBAC.', technologies: ['FastAPI', 'Python', 'React', 'TypeScript', 'PostgreSQL', 'Redis', 'Ollama', 'Whisper', 'PyTorch', 'Docker', 'Terraform', 'CUDA'], image: './images/aihr.png', links: [{ label: 'Live', url: 'https://aihr.daffodilglobal.ai/' }] },
