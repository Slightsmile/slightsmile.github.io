...
const DATA = {
    ...
    projects: [
        { title: 'AIHR Platform', description: 'A multi-tenant AI-powered HR platform with on-premise AI inference, tenant-isolated databases, video interview intelligence, CV matching, employee engagement, performance management, workforce insights, and enterprise-grade RBAC.', technologies: ['FastAPI', 'Python', 'React', 'TypeScript', 'PostgreSQL', 'Redis', 'Ollama', 'Whisper', 'PyTorch', 'Docker', 'Terraform', 'CUDA'], image: './images/aihr.png', links: [{ label: 'Live', url: 'https://aihr.daffodilglobal.ai/' }] },
        { title: 'Barighor', description: 'A digital rent notebook SaaS for landlords in Bangladesh to manage buildings, tenants, rent collection, due payments, invoices, notices, and caretaker access.', technologies: ['Next.js', 'TypeScript', 'Express.js', 'PostgreSQL', 'Supabase', 'Prisma', 'Tailwind CSS'], image: './images/barighor.png', links: [{ label: 'Live', url: 'https://barighor.vercel.app/' }] },
        ...
        { title: 'Grameen Pest Control', description: 'A full-stack website with a built-in CMS admin panel for a pest control service business in Bangladesh.', technologies: ['Node.js', 'HTML', 'CSS', 'JS'], image: './images/grameenpest.png', links: [{ label: 'Live', url: 'https://grameenpestbd.com/' }] },
...
function renderProjects() {
    ...
    DATA.projects.forEach((project, index) => {
        ...
        tagsDiv.className = 'flex flex-wrap gap-2 mb-4 pointer-events-none tag-list-clamp';
        ...
        if (project.links && project.links.length > 0) {
            ...
            // Keep button anchored near the bottom of the card
