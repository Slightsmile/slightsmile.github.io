...
export const PROJECTS_DATA = [
  ...
  { id: 'geekpedia', category: 'web', title: 'Geekpedia', desc: 'A franchise viewing-guide platform with curated watch orders for the MCU, Star Wars, and dozens of other movie, TV, and game universes, with Noob, Geek, and Lore Master difficulty modes plus progress tracking.', tags: ['TypeScript', 'React', 'Next.js'], image: '/images/geekpedia.svg', logo: true, logoInk: 'white', logoZoom: 2.9, githubUrl: 'https://github.com/Slightsmile/geekpedia', liveUrl: 'https://geekpedia-pi.vercel.app/' },
  { id: 'github-treasure', category: 'web', title: 'GitHub Treasure', desc: 'A curated discovery platform surfacing underrated open-source projects across 17 categories, helping developers find quality software that would otherwise stay hidden.', tags: ['TypeScript', 'React', 'Next.js'], image: '/images/githubtreasure.svg', logo: true, logoInk: 'white', logoZoom: 2.2, githubUrl: 'https://github.com/Slightsmile/github-treasure', liveUrl: 'https://github-treasure.vercel.app/' },
